...
class Model(base_layer.Layer, version_utils.ModelVersionSelector):
  ...
  def make_train_function(self, force=False):
    ...
    def train_function(iterator, steps_per_execution=1):
    ...
    if self._cluster_coordinator:
      self.train_function = lambda it: self._cluster_coordinator.schedule(  # pylint: disable=g-long-lambda
          train_function,
          args=(it, steps_per_execution()))
    else:
      self.train_function = lambda it: train_function(it, steps_per_execution())
  ...
  def make_test_function(self, force=False):
    ...
    def test_function(iterator, steps_per_execution=1):
  ...
  def make_predict_function(self, force=False):
    ...
    def predict_function(iterator, steps_per_execution=1):
      """Runs an evaluation execution with multiple steps."""
      outputs = step_function(self, iterator)
      if steps_per_execution > 1:
        for _ in tf.range(steps_per_execution - 1):
